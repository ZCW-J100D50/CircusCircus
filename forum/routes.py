...
#
# @rt.route('/action_login', methods=['POST']) #done
# def action_login():
...
#
# @login_required
# @rt.route('/action_logout') #done
# def action_logout():
# 	#todo
# 	logout_user()
# 	return redirect("/")
#
# @rt.route('/action_createaccount', methods=['POST']) #done
...
#
# @login_required
# @rt.route('/action_comment', methods=['POST', 'GET']) #done
# def comment():
...
#
# @login_required
# @rt.route('/action_post', methods=['POST']) #done
# def action_post():
# 	subforum_id = int(request.args.get("sub"))
# 	subforum = Subforum.query.filter(Subforum.id == subforum_id).first()
# 	if not subforum:
